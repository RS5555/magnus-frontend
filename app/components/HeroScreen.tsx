...
//     subHeading:
//       "Pimpri-Chinchwad mein ghar lena koi mazaak nahi, par 'Zidd' ho aur 'Magnus Corps' ka Sath ho toh har namumkin, mumkin hai.",
//   },
//   {
//     src: "/HomeImage5.png",
//     scaleTarget: 1.0,
...
//                         <span className="text-2xl md:text-3xl lg:text-4xl italic font-light text-[#8b735b] my-1 md:my-2 lowercase tracking-widest">
//                           vs
//                         </span>
//                         <span>Apna Ghar</span>
//                       </>
    ...
    >
      ...
      <div className="absolute inset-0 z-0 flex items-center justify-center">
        <video
          ...
          muted
          playsInline
          /* object-contain on mobile: shows the full video.
             md:object-cover on desktop: fills the entire screen.
          */
          className="h-full w-full object-contain md:object-cover grayscale-[0.2]"
        >
          <source src="/Magnus 4.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </video>
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/5 via-transparent to-black/20 z-10 pointer-events-none" />
      </div>

      {/* 2. Bottom UI: Socials & Info */}
      <div className="absolute bottom-6 md:bottom-12 left-0 w-full z-30 px-6 md:px-12">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center md:items-end justify-between gap-6 md:gap-0">
          
          {/* Social Icons */}
          <div className="flex items-center gap-6 md:gap-10 order-2 md:order-1">
            <SocialIcon Icon={FaInstagram} href="/" />
            <SocialIcon Icon={FaFacebookF} href="/" />
            <SocialIcon Icon={FaLinkedinIn} href="/" />
            <SocialIcon Icon={FaYoutube} href="/" />
          ...
          {/* Headquarters Info */}
          <div className="text-center md:text-right order-1 md:order-2">
            <p className="text-[9px] md:text-[10px] uppercase tracking-[0.4em] md:tracking-[0.8em] font-bold text-[#805e3a] lg:text-[#422f1b] mb-1">
              Magnus Headquarters
            </p>
            <p className="text-[9px] md:text-[10px] text-[#FFFFFF] lg:text-[#422f1b] tracking-tighter">
              411019 • PUNE, MAHARASHTRA
            </p>
          </div>
        </div>
...
function SocialIcon({ Icon, href }: { Icon: any; href: string }) {
  return (
    <motion.a
      ...
      rel="noopener noreferrer"
      whileHover={{ y: -5, color: "#8b735b" }}
      className="text-[#FFFFFF] lg:text-[#422f1b] hover:text-[#8b735b] transition-colors duration-300"
    >
